/*
 * Filename: mexDsmooth_poly_C2.c
 * Author: Hantao Nie (nht@pku.edu.cn)
 * Date: 2023-05-31 10:43:09
 * LastEditors: Hantao Nie (nht@pku.edu.cn)
 * LastEditTime: 2024-02-29 20:36:59
 * Description: derivative of smooth polynomial with C2 continuity
 *      usage
 *      [X] = mexDsmooth_poly_C2(Z, epsilon)
 * 
...
inline double phi(double z, double epsilon)
{
    if (z <= 0)
        ...
        return - 2 * z * z * z /( epsilon * epsilon * epsilon) + 3 * z * z / (epsilon * epsilon);
    else
        return 1;
}
