/*
 * Filename: mexsmooth_poly_C2.c
 * Author: Hantao Nie (nht@pku.edu.cn)
 * Date: 2023-05-31 10:43:09
 * LastEditors: Hantao Nie (nht@pku.edu.cn)
 * LastEditTime: 2024-02-29 20:33:41
 * Description: smooth polynomial with C2 continuity
 *      usage
...
inline double phi(double z, double epsilon)
{
    if (z <= 0)
        ...
        return - z * z * z * z /( 2 * epsilon * epsilon * epsilon) + z * z * z/ (epsilon * epsilon);
    else
        return z - epsilon / 2;
}
