...
%  LastEditTime: 2023-12-23 17:49:42
%  
%  Copyright (c) 2023, Hantao Nie, Peking University. 
%   

function out = Qsqrt(X, Y, cone_size)
    ...
    if strcmp(Y, 'mat')
        ...
        inprod = socp.inner_product(X, Y, cone_size);
        temp = (Y(ind_head) .* sqrtdetX + inprod) ./ (sqrtdetX + X(ind_head)); 
